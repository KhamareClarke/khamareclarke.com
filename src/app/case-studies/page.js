      ...
      <Section className="py-ds-6 relative z-10">
            ...
            {[
              {
                ...
                result: "20+ hours saved per week with AI chatbots"
              },
              {
                icon: "🛒",
                industry: "E-commerce & Retail",
                result: "2x online sales with custom platforms"
              },
              {
                icon: "📈",
                industry: "Marketing Agencies",
                result: "40% more qualified leads with AI automation"
              },
              {
                icon: "🏢",
                industry: "Professional Services",
                result: "3x ROI with automated booking systems"
              },
              {
                icon: "🏥",
                industry: "Healthcare & Wellness",
                result: "90% reduction in admin work"
              },
              {
                icon: "🎓",
                industry: "Education & Training",
                result: "24/7 student support with AI assistants"
              }
            ].map((item, index) => (
              <motion.div
                key={index}
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">
            Ready to Become the <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ffb700] to-[#ff8c00]">Next Success Story?</span>
          </h2>
          <p className="text-xl text-[#ADB7BE] mb-8 max-w-2xl mx-auto">
            Let's discuss how AI automation can deliver similar results for your business.
          </p>
          <CTAButton caption="Designed for teams ready to turn proven systems into predictable growth.">Book Your Free Strategy Call</CTAButton>
        </motion.div>
        </Container>
      </Section>
