...
export default function JarvisCommandPalette() {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-start justify-center pt-[20vh] px-4">
      ...
      <form
        onSubmit={submit}
        className="relative w-full max-w-lg rounded-xl border border-[#ffb700]/30 bg-[#0a0a0a] shadow-2xl overflow-hidden"
        role="dialog"
