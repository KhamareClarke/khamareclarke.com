    ...
    <JarvisHudFrame>
      ...
      >
        ...
        <header className="jarvis-topbar relative z-30 shrink-0 flex items-center justify-between gap-3 px-4 md:px-6 py-3 border-b border-[#ffb700]/10">
          ...
          {/* Right cluster: weather + status dots + settings */}
          <div className="flex items-center gap-2.5">
            <div className="hidden lg:block">
              <JarvisWeather />
            </div>
            <div className="hidden xl:flex items-center gap-3 px-3 border-l border-[#ffb700]/10">
              <StatusDot label="Fleet"     online={true} />
              <StatusDot label="Empire OS" online={Boolean(liveData?.ok)} />
              <StatusDot label="Supabase"  online={true} />
            </div>
